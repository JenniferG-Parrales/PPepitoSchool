...
{
    public partial class FormPincipoal : Form
    {
        public IEstudianteService estudiantesServices { get; set; }
        int index;
        Estudiante est;
        public FormPincipoal(int index)
        {
            this.index = index;
            InitializeComponent();
        }

        private void FormPincipoal_Load(object sender, EventArgs e)
        {
            if (index != -50)
            {
